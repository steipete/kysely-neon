...
import { ClientConfig, NeonConfig, Pool, PoolClient, neonConfig } from "@neondatabase/serverless";
...
class NeonDriver implements Driver {
  ...
  async beginTransaction(conn: NeonConnection, settings: TransactionSettings): Promise<void> {
